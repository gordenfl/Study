# Code Implement for the System design interview

All the information are all in the code comment, read the code with the comment, you will get the total logic.
